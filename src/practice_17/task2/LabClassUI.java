...
public class LabClassUI extends JFrame {
    ...
    public LabClassUI(ArrayList<Student> students){
        ...
        // Table
        Object[] headers = new String[] {"FIO", "Age", "GroupId", "AverageScore"};
    ...
    private void findBtnClicked() throws StudentNotFoundException {
        String s = JOptionPane.showInputDialog("Input FIO to do search");
        for(int i = 0; i < students.size(); i++){
            if(students.get(i).getFio().equals(s)){
                JOptionPane.showMessageDialog(this, "Found student: "+
    ...
    private void remBtnClicked() {
        ...
        if(c != 1) {
            JOptionPane.showMessageDialog(this, "Choose just one row!");
            return;
        }
    ...
    private void addBtnClicked() throws IllegalArgumentException {
        String fio = JOptionPane.showInputDialog("Input FIO!");
        if(fio.equals("")) throw new EmptyStringException();
        String age = JOptionPane.showInputDialog("Input age!");
        String group = JOptionPane.showInputDialog("Input group number!");
        String avg = JOptionPane.showInputDialog("Input average score!");
        ...
        try {
            ...
            throw new NumberFormatException("It is impossible to transform string "+e.getMessage().substring(17) + " to number!");
        }
