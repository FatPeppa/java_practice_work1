...
public class task4_extra extends JFrame {
    ...
    public task4_extra(){
        ...
        playButton.addActionListener(e->{
            JOptionPane.showMessageDialog(this, new task1(firstStart.getText(), secondStart.getText()).play());
            firstStart.setText("");
            secondStart.setText("");
            curAdd.setText("0");
    ...
    public static void main(String[] args) {
        new task4_extra().setVisible(true);
    }
}
